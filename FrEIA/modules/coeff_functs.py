...
class F_fully_connected(nn.Module):
	...
	def __init__(self, size_in, size, internal_size=None, dropout=0.0):
		...
		"""
		self.fc1 = VBLinear(size_in, internal_size)
		self.fc2 = VBLinear(internal_size, internal_size)
		self.fc2b = VBLinear(internal_size, internal_size)
		self.fc3 = VBLinear(internal_size, size)
